...
def create_schema() -> Schema:
    ...
    category_list_col = ColumnSchema(
        name="category_list",
        dtype="int32",
        tags=[Tags.LIST, Tags.CATEGORICAL],
        is_list=True,
        is_ragged=True,
    ).with_properties(
        {"domain": {"min": 0, "max": 2975}, "value_count": {"min": 1, "max": 500}}
    )

    sentiment_list_col = ColumnSchema(
        name="sentiment_list",
        dtype="float64",
        tags=[Tags.LIST, Tags.CONTINUOUS],
        is_list=True,
    ...
    pageviews_list_col = ColumnSchema(
        name="total_pageviews_list",
        dtype="int32",
        tags=[Tags.LIST, Tags.CONTINUOUS],
        is_list=True,
        is_ragged=True,
